...
//EXPLAINED in EfficientMarkovModel
//stores follows after first getting it so that subsequent need of follows will refer to the stored
//data instead of generating all over again which will be time consuming in the case of large training
//text
