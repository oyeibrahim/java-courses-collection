...
/** HelloWorld
  ...
  * Date: July 17, 2015   Date: April 1, 2019
  * */
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		//-------------------------------------------------------
		//add the second map and position it beside the first map
		//using 375 in x to position it beside map1 with some space
		map2 = new UnfoldingMap(this, 425, 50, 325, 500, provider);
		
		// center it to osogbo 7.7827 (latitude) 4.5418 (longitude)
	    map2.zoomAndPanTo(zoomLevel, new Location(7.7827f, 4.5418f));
		
		// Make the second map also interactive
	...
	public void draw() {
		...
		//-------------------------------------------------------
		//draw map2 so that it becomes visible
		map2.draw();
		//-------------------------------------------------------
	}
