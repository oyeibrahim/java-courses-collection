...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public int compareTo(EarthquakeMarker marker){
		//normally we use the @param as second parameter to sort in order 
		//i.e compare(this.getMagnitude(), marker.getMagnitude());
		
		//but because we are to sort in reverse order in this assignment, we just change the arrangement 
		//to give a reverse sort
 		return Double.compare(marker.getMagnitude(), this.getMagnitude()); 
